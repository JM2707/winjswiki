...
### Tests Status 
Please refer to [http://winjs.azurewebsites.net/#status](http://winjs.azurewebsites.net/#status) for the latest status of the unit tests and the list of known issues.